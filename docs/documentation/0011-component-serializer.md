...
The `examples/` directory at the root of the project contains a runnable serializer example (`serializer`).
The code you find there contains comments with what is happening. [examples/serializer](../../examples/serializer)
