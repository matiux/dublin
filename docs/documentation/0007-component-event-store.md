...
an event store. It currently has an in-memory event store implementation that is useful for using in tests.
...
* [broadway/event-store-dbal](https://github.com/matiux/dublin-event-store-dbal)
