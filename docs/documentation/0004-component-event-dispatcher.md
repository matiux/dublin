...
The `examples/` directory at the root of the project contains a runnable event dispatcher example (`event-dispatcher`).
The code you find there contains comments with what is happening. [examples/event-dispatcher](../../examples/event-dispatcher)
